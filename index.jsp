			...
			<div class="wrapper">
						...
						<div class="onecolblock">
							...
							<div id="Content">
								<div class="holder">
									...
									<p>The Case Tracker allows users to search for information on applications or appeals in the Court of Appeal, Civil Division.  Users are also able to search for information on applications or appeals heard in the last 31 days. You can search for a case in the following three ways:</p>

									<ul class="listFix">
										<li><strong>By Case Number</strong> &ndash; The case number for the case needs to be 8 digits long and must be entered in the following format, without any spaces or oblique strokes: 20051234;</li>
										<li><strong>By Title</strong> &ndash; The title can be entered using the names of either party. For example, in the case of Smith &amp; Co v Jones, either &quot;Smith&quot; or &quot;Jones&quot; can be entered to search; and</li>
										<li><strong>By Date</strong> &ndash; A date of hearing can be entered in the following format DD-MMM-YY eg: 15&ndash;Jan&ndash;09, or you can click the calendar icon and choose a date from the pop&ndash;up calendar.</li>
									</ul>

									<p>For confirmation of the judges hearing your case, the time and location of the hearing, please check the <a href="http://www.justice.gov.uk/guidance/courts-and-tribunals/courts/daily-court-hearings.htm" target="_blank">Daily List</a> from 14:30 the working day before your case is due to be heard, or call the Listing Office.</p>
									<p>Information is provided in good faith for the convenience of court users and others. Whilst we endeavour to ensure that the information is correct, listing dates and constitutions in particular are subject to change.</p>
				...
				<div id="TopBar">
					<div class="holder">
						...
						<a href="http://www.justice.gov.uk/index.htm" tabindex="1"><img src="images/logo.png" alt="Link to the Justice homepage" /></a>
					</div>
				</div>
				<!-- End of Top Bar -->
