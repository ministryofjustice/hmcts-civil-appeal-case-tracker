...
<!--[if gt IE 8]><!--><html lang="en"><!--<![endif]-->
  ...
  <body>
    ...
    <main id="content" role="main">
      ...
      <p>Click the &quot;Calendar&quot; icon below to enter a date or enter a "Case number" or "Title", and click the search button</p>
        ...
        <div class="formwrap">
          ...
          <div class="formcon">
              ...
              <display:table id="result" name="sessionScope.results" requestURI="" pagesize="15" sort="list">
                ...
                <display:column property="case_no" title="Case number" paramId="case_id" paramProperty="case_no" href="getDetail.do" />
